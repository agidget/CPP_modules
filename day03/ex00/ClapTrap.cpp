...
ClapTrap::ClapTrap(std::string str) : hitpoints(10), energy(10), attackDamage(0)
{
...
{
	std::cout << "\033[0;34mClapTrap take " << amount << " amount of damage!" << std::endl;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->energy -=amount;
		std::cout << "\033[0;32mClapTrap is being repaired by " << amount;
